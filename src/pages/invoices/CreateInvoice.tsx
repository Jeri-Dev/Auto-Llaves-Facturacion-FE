...
export default function CreateInvoice() {
  ...
  const [inventoryItems, setInventoryItems] =
    useState<PaginatedResponse<Inventory>>();
  ...
  const requiresCustomer = ["GOVERNMENTAL", "QUOTE", "CREDIT"].includes(
    formik.values.type
  );
              ...
              <Stack direction={{ xs: "column", md: "row" }} spacing={3}>
                ...
                >
                  ...
                  >
                    ...
                    <MenuItem value={InvoiceType.GOVERNMENTAL}>
                      Gubernamental
                    </MenuItem>
                    <MenuItem value={InvoiceType.QUOTE}>Cotización</MenuItem>
                    <MenuItem value={InvoiceType.CREDIT}>
                      Crédito Fiscal
                    </MenuItem>
                    <MenuItem value={InvoiceType.BASIC}>Básica</MenuItem>
                    <MenuItem value={InvoiceType.ENDCONSUMER}>
                      Consumidor Final
                    </MenuItem>
                  </Select>
