...
export default function CompanySettings() {
  const { company, loading, error, fetchCurrentCompany, createCompany, updateCompany } = useCompanyStore()
            ...
            <Stack spacing={4}>
              ...
              <Box display="flex" gap={2} justifyContent="flex-end" pt={2}>
                <Button
                  ...
                  disabled={loading}
                >
                  {loading ? 'Guardando...' : company ? 'Actualizar Configuración' : 'Crear Empresa'}
                </Button>
              </Box>
            </Stack>
          </form>
